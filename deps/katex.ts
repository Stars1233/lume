import katex, { type KatexOptions as BaseOptions } from "npm:katex@0.16.45";
import "npm:katex@0.16.45/contrib/mhchem";

export const assetsUrl = "https://cdn.jsdelivr.net/npm/katex@0.16.45/dist";
